# -*- coding: utf-8 -*-
"""
Created on Mon Apr  4 17:50:05 2022
...
def firstDerivative_filter(image,filter_size):
   ...
   #initializing FILTER
    ...
    #Filter = [[-1,-2,-1],[0,0,0],[1,2,1]] # Along Y axis
    Filter = [[-1,0,1],[-2,0,2],[-1,0,1]]  # Along X axis 
...
#ax[0].set_title('Sobel filter Horizontal mask of size ' +str(filter_size) +' x ' + str(filter_size))
ax[0].set_title('Sobel filter Vertical mask of size ' +str(filter_size) +' x ' + str(filter_size))
