# -*- coding: utf-8 -*-
"""
Created on Sun Apr  3 21:17:44 2022
...
def secondDerivative_filter(image,filter_size):
   ...
   #initializing FILTER
    ...
    #Laplacian Image Enhancement (Original - Laplacian Filtered Img = Sharpened Image)
...
final_img = secondDerivative_filter(loaded_img,filter_size)
...
#ax[0].set_title('Laplacina Filtered image using filter of size ' +str(filter_size) +' x ' + str(filter_size)) 
ax[0].set_title('Laplacian Enhanced Image using filter of size ' +str(filter_size) +' x ' + str(filter_size))
